    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if (frecuenciaFundamental <= 550 && frecuenciaFundamental >= 250)
                {
                    Coloreado.Text = "Rojo";
                }
                ...
                if (frecuenciaFundamental <= 950 && frecuenciaFundamental >= 650)
                {
                    Coloreado.Text = "Verde";
                }

                else

                if (frecuenciaFundamental <= 1350 && frecuenciaFundamental >= 1050)
                {
                    Coloreado.Text = "Morado";
                }

                else

                if (frecuenciaFundamental <= 1750 && frecuenciaFundamental >= 1450)
                {
                    Coloreado.Text = "Azul";
                }
                ...
                if (frecuenciaFundamental <= 2150 && frecuenciaFundamental >= 1850)
                {
                    Coloreado.Text = "Rojo";
                }
